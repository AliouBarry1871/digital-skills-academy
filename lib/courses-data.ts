...
export const DEFAULT_COURSES: Course[] = [
  ...
  // =========================================================================
  {
    ...
    is_premium: true,
    premium_features: [
      'Maîtrise complète de NumPy et du calcul vectoriel haute performance',
      'Filtrage booléen avancé et indexation multidimensionnelle de jeux de données',
      'Visualisation graphique scientifique de données avec Matplotlib',
      'Traitement et analyse de dataframes complexes avec Pandas',
    ],
    lessons: [
      {
        id: 'py-adv-1',
  ...
  // =========================================================================
  {
    ...
    lessons: [
      {
        id: 'web-fr-1',
        title: 'Module 1 : Les Fondations du Web, Architecture & Rôle de HTML',
        description: 'Découvrir le fonctionnement des navigateurs, les éditeurs de code et la structure fondamentale d\'un document web.',
      ...
      {
        id: 'web-fr-2',
        title: 'Module 2 : La Syntaxe HTML, Balises Essentielles et Attributs',
        description: 'Maîtriser les balises de texte, liens hypertextes, images et l\'arborescence du code HTML.',
      ...
      {
        id: 'web-fr-3',
        title: 'Module 3 : Intégration Complète d\'une Page Web HTML5 Pas-à-Pas',
        description: 'Structuration moderne avec les balises header, nav, main, section et footer dans un projet complet.',
